$(document).ready(function () {
  ...
  function submitForm() {
    ...
    if (form.checkValidity()) {
        ...
        alert("This is just for show, there is no database. If you want to contact Abhay Sharma then you can do it using let's connect ! section, provide all the valid details.")
        // Reset the form
        form.reset();
    } else {
